...
Постановление Главного государственного санитарного врача РФ от 27.05.2016 N 69 признано утратившим силу с 01.01.2021 Постановлением Правительства РФ от 08.10.2020 N 1631.
...
Среднесуточные наборы пищевой продукции для детей до 7-ми лет (в нетто г, мл на 1 ребенка в сутки)

| № | Наименование пищевой продукции или группы пищевой продукции | 1-3 года | 3-7 лет |
|---|-------------------------------------------------------------|----------|---------|
...
Среднесуточные наборы пищевой продукции для организации питания детей, находящихся в организациях для детей-сирот и детей, оставшихся без попечения родителей от 1 года (в нетто, г, мл, на 1 ребенка в сутки)

| Наименование вида пищевой продукции | 12-18 месяцев | 18 месяцев-3 года | 3 года-7 лет | 7-11 лет | 12 лет и старше |
|-------------------------------------|---------------|-------------------|--------------|----------|-----------------|
...
# Таблица продуктов питания для детей первого года жизни

| Наименование видов пищевой продукции и блюд | 2 мес | 3 мес | 4 мес | 5 мес | 6 мес | 7 мес | 8 мес | 9-12 мес |
|---------------------------------------------|-------|-------|-------|-------|-------|-------|-------|----------|
...
| Кефир и неадаптированные кисломолочные продукты (мл) | - | - | - | - | - | 200 | 200 | - |
...
Среднесуточные наборы пищевой продукции для организации питания кадетов, обучающихся в образовательных организациях кадетского типа и кадетской направленности (в нетто г, мл, на 1 чел. в сутки)

| Наименование видов пищевой продукции питания | 5-8 класс | 9-11 класс |
|---------------------------------------------|-----------|------------|
...
## МЕНЮ ПРИГОТАВЛИВАЕХ БЛЮД

**Возрастная категория:** от 1 года до 3 лет / 3-6 лет / 7-11 лет / 12 лет и старше

| Прием пищи | Наименование блюда | Вес блюда | Белки | Жиры | Углеводы | Энергетическая ценность | N рецептуры |
|------------|-------------------|-----------|-------|------|----------|------------------------|-------------|
| **Неделя 1 День 1** | | | | | | | |
| **Завтрак** | | | | | | | |
| | | | | | | | |
...
| Показатели | 1-3 лет | 3-7 лет | 7-11 лет | 12 лет и старше |
|:---|:---:|:---:|:---:|:---:|
...
| **Витамин В₁ (мг/сут)** | 0,8 | 0,9 | 1,2 | 1,4 |
| **Витамин В₂ (мг/сут)** | 0,9 | 1,0 | 1,4 | 1,6 |
...
| Приемы пищи | 8-10 часов | 11-12 часов | 24 часа |
|-------------|------------|-------------|---------|
| Завтрак | завтрак | завтрак | Завтрак |
| Второй завтрак | второй завтрак | второй завтрак | второй завтрак |
| Обед | Обед | Обед | Обед |
| Полдник | полдник | полдник | Полдник |
| Ужин | - | ужин | Ужин |
| Второй ужин | - | - | второй ужин |
...
**с \_\_\_\_\_\_\_\_\_\_\_\_\_ по \_\_\_\_\_\_\_\_\_\_\_\_\_**
